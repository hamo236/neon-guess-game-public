...
let oneTeam = confirmTeamRound(state, 'p3', 1000, { targetSnapshot: { id: 'target-a', targetId: 'target-a', name: 'A', image: '/a.png' } });
if (areAllRequiredTeamConfirmationsComplete(oneTeam)) throw new Error('One teammate confirmation must not resolve the team.');
oneTeam = confirmTeamRound(oneTeam, 'p4', 1001, { targetSnapshot: { id: 'target-a', targetId: 'target-a', name: 'A', image: '/a.png' } });
...
let simultaneous = confirmTeamRound(simultaneousSeed, 'p1', 2000);
simultaneous = confirmTeamRound(simultaneous, 'p2', 2001);
simultaneous = confirmTeamRound(simultaneous, 'p3', 2002);
simultaneous = confirmTeamRound(simultaneous, 'p4', 2003);
