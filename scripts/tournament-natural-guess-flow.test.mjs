...
assert.match(gameplay, /const targetId = target\?\.targetId \|\| target\?\.id/, 'Four must normalize both legacy and Firebase target identifier shapes before gating the button');
